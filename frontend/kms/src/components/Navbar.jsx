    ...
    return (
        <div className="flex flex-col justify-center bg-black p-3">
            ...
            <div className={fullNavbar.includes(location.pathname) ? 'h-[25vh] sm:h-[35vh] flex flex-col justify-center items-center' : 'hidden'}>
                <div>
                    <p className="text-white text-xl text-center sm:text-3xl mt-5">Welcome to Ipsums' Knowledge Base</p>
                ...
                <div class="w-full max-w-sm min-w-[200px] mt-3 lg:mt-10 p-5">
                    <div class="relative">
                        ...
                        />
                        <button
                            class="absolute top-2 right-1 flex items-center rounded bg-white py-1 px-2.5 border border-transparent text-center text-sm text-black transition-all shadow-sm hover:shadow active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                            type="button"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 mr-2">
                                <path fill-rule="evenodd" d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z" clip-rule="evenodd" />
