                    ...
                    <div className="flex justify-center items-center space-x-5 mt-5">
                        ...
                        <div class="w-full max-w-sm min-w-[200px]">
                            <input value={companyTagline}
                                ...
                                class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Company tagline" />
                        </div>
                    </div>
                </div>
            ...
            case 4:
                return <div>
                    ...
                    <div class="w-full max-w-sm min-w-[200px] mt-5">
                        <div class="relative">
                            <input type="text" class="w-full pl-3 pr-10 py-2 bg-transparent placeholder:text-slate-400 text-slate-600 text-sm border border-slate-200 rounded-md transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Username" />
                    ...
                    <div class="w-full max-w-sm min-w-[200px] mt-5">
                        <div class="relative">
                            <input type="email" class="w-full pl-3 pr-10 py-2 bg-transparent placeholder:text-slate-400 text-slate-600 text-sm border border-slate-200 rounded-md transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Email" />
                    ...
                    <div class="w-full max-w-sm min-w-[200px] mt-5">
                        <div class="relative">
                            <input type="password" class="w-full pl-3 pr-10 py-2 bg-transparent placeholder:text-slate-400 text-slate-600 text-sm border border-slate-200 rounded-md transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Password" />
                    ...
                    <div className="flex justify-between p-3">
                        <div>
                            {component === 0 ? (
                                ...
                                <button onClick={previousComponent} class="rounded-md bg-black py-2 px-4 border border-transparent text-center text-sm text-white  ml-2" type="button">
                                    Previous
                                </button>
                            )}
                        </div>
                        ...
                        <div>
                            <button onClick={nextComponent} class="rounded-md bg-black py-2 px-4 border border-transparent text-center text-sm text-white  ml-2" type="button">
                                Next
                            </button>
                        </div>
                    </div>
